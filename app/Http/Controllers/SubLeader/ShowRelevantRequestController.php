...
class ShowRelevantRequestController extends Controller
{
    public function index()
    {
        ...
        $data = Request::join('relaters', 'requests.id', '=', 'relaters.request_id')
            ...
            ->where('relaters.user_id', '=', $id)
            ->get();

        return view('database_manager.show_list_congvieclienquan.show_subleader')->with(['indi_data' => $data]);
    }
